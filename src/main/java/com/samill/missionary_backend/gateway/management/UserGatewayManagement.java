...
public class UserGatewayManagement {
    ...
    public void createParticipation(CreateParticipationRequest createParticipationRequest, MemberContext memberContext) throws CommonException, CommonException {
